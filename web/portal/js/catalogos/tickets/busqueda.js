...
{ dataKey: "fechasinc", visible:true, headerText: "Fechasinc" },
{ dataKey: "tienda", visible:true, headerText: "Tienda" },
{ dataKey: "clave", visible:true, headerText: "Clave" },
{ dataKey: "fecha", visible:true, headerText: "Fecha" },
{ dataKey: "hora", visible:true, headerText: "Hora" },
...
{ dataKey: "estatus", visible:true, headerText: "Estatus" },
{ dataKey: "factura", visible:true, headerText: "Factura" },
{ dataKey: "efectivo", visible:true, headerText: "Efectivo" },
{ dataKey: "vales", visible:true, headerText: "Vales" },
{ dataKey: "cheques", visible:true, headerText: "Cheques" },
{ dataKey: "otros", visible:true, headerText: "Otros" },
{ dataKey: "descuento", visible:true, headerText: "Descuento" },
{ dataKey: "cortecaja", visible:true, headerText: "Cortecaja" },
{ dataKey: "clientenombre", visible:true, headerText: "Clientenombre" },
{ dataKey: "cxcob", visible:true, headerText: "Cxcob" },
{ dataKey: "usuario", visible:true, headerText: "Usuario" },
{ dataKey: "vendedor", visible:true, headerText: "Vendedor" },
{ dataKey: "colonia", visible:true, headerText: "Colonia" },
{ dataKey: "dolares", visible:true, headerText: "Dolares" },
{ dataKey: "tipocambio", visible:true, headerText: "Tipocambio" },
{ dataKey: "clavevale", visible:true, headerText: "Clavevale" },
{ dataKey: "sinc", visible:true, headerText: "Sinc" },
