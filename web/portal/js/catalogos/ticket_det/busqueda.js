var Busquedaticket_det=function(){
...
{ dataKey: "numero", visible:true, headerText: "Numero" },
{ dataKey: "primario", visible:true, headerText: "Primario" },
...
{ dataKey: "modo", visible:true, headerText: "Modo" },
{ dataKey: "mecanico", visible:true, headerText: "Mecanico" },
{ dataKey: "nivel", visible:true, headerText: "Nivel" },
{ dataKey: "factor", visible:true, headerText: "Factor" },
{ dataKey: "cantidad1", visible:true, headerText: "Cantidad1" },
{ dataKey: "cantidad2", visible:true, headerText: "Cantidad2" },
{ dataKey: "iva", visible:true, headerText: "Iva" },
{ dataKey: "unidadfactor", visible:true, headerText: "Unidadfactor" },
{ dataKey: "costopromedio", visible:true, headerText: "Costopromedio" },
{ dataKey: "descuento", visible:true, headerText: "Descuento" },
{ dataKey: "nivelprecio", visible:true, headerText: "Nivelprecio" },
{ dataKey: "espera", visible:true, headerText: "Espera" },
{ dataKey: "precioiva", visible:true, headerText: "Precioiva" },
{ dataKey: "resurtido", visible:true, headerText: "Resurtido" },
