...
(function (wijmo) {
    ...
    var wijupload = (function (_super) {
        ...
        wijupload.prototype._initSwfUploadOptions = function () {
        ...
        wijupload.prototype._createUploader = function (fileRow) {
            var self = this, inputFile = $("input", fileRow), action = self.options.action, uploader;
            if(self.useXhr) {
