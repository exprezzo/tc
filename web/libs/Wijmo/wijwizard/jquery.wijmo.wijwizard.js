...
(function (wijmo) {
    ...
    wijwizard.prototype.options = $.extend(true, {
        ...
        /// Cached content can then be lazy loaded,
        /// for example only once when the panel is displayed.
        ...
        false,
        cookie: /// <summary>
        /// The cookie option is a value that store the latest active index
        /// in a cookie.
