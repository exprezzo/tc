...
(function (wijmo) {
    ...
    var wijgrid = (function (_super) {
        ...
        wijgrid.prototype._rebuildLeaves = function () {
            ...
            this._field("columnHeadersTable", new wijmo.grid.bandProcessor().generateSpanTable(tmpColumns, leaves));
    ...
    (function (grid) {
        ...
        var dataViewWrapper = (function () {
            function dataViewWrapper(wijgrid) {
                ...
                this._isRemoteWijdatasource = false;
            ...
            dataViewWrapper.prototype.load = function (userData) {
                ...
                if(this._needToLoad(sm)) {
                    ...
                    if(this._isRemoteWijdatasource && !this._isDynamicWijdatasource && dataView.isLoaded()) {
                        local = true;
                    }
            ...
            dataViewWrapper.prototype._needToLoad = function (settingsManager) {
                var dataView = this._getDataViewInst();
                if(this._isDynamicWijdatasource || (this._isRemoteWijdatasource && !dataView.isLoaded())) {
                    return true;
                }
            ...
            function (dataView, request) {
                ...
                for(i = 0 , len = dataView.count(); i < len; i++) {
                    for(j = 0 , len2 = tallies.length; j < len2; j++) {
                        tallies[j].add(this._wijgrid._parse(request[j].column, dataView.getProperty(i, request[j].column.dataKey)));
                    }
                }
    ...
    (function (grid) {
        ...
        var cellInfo = (function () {
            ...
            cellInfo.prototype.value = function (value/*opt*/ ) {
                ...
                /// </remarks>
                                var column, rowInfo, colVal, dataView;
                if(this._wijgrid && this._isValid()) {
                    ...
                    if(rowInfo.type & wijmo.grid.rowType.data) {
                        ...
                        if(arguments.length === 0) {
                            // getter
                            dataView = this._wijgrid._dataViewWrapper.dataView();
                            colVal = dataView.getProperty(rowInfo.data, column.dataKey);
    ...
    (function (grid) {
        ...
        var baseView = (function () {
            ...
            baseView.prototype._renderHeader = function () {
                var $rt = wijmo.grid.rowType, cht = this._wijgrid._field("columnHeadersTable"), i, height, rowInfo;
            ...
            baseView.prototype._renderHeaderRow = function (rowInfo, item) {
                var i, len, thX = 0, span;
                for(i = 0 , len = item.length; i < len; i++) {
                    span = item[i];
                    if(span.column && span.column.parentVis) {
                        span.column.thX = thX++;
                        span.column.thY = rowInfo.sectionRowIndex;
                        this._renderCell(rowInfo, i, span.column.headerText, false, span.column, {
