...
///<reference path='portfolioItem.ts'/>
...
class ViewModel {
    ...
    scope = null; // << needed to update view?
    ...
    constructor(scope = null) {
	    ...
	    // auto-complete functions to provide matches and select new symbols.
        this.autoCompleteSource = (req, res) => res(this.getSymbolMatches(req))
        this.autoCompleteClose = function() {
            self.portfolio.newSymbol = $(this).val();
            self.updateView();
        };
    }
    ...
    updateView() {
        ...
        // update canAddNewSymbol property
        ...
        // update chart data for all items
        ...
        catch (err) { /* probably already updating */ }
    }
